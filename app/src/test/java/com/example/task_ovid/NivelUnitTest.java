...
public class NivelUnitTest {
   @Test
    public void testIncrementarExperiencia() {
        ...
        assertFalse(Nivel.incrementarExperiencia(true,false));
        //Se incrementa la experiencia en 50 otra vez por lo que sube de nivel y debe devolver true
        assertTrue(Nivel.incrementarExperiencia(true,false));
        ...
        for (int i = 0; i < 11; i++) {
            assertFalse(Nivel.incrementarExperiencia(false,false));
        }
        //La doceava llamada debe ser true
        assertTrue(Nivel.incrementarExperiencia(false,false));
    }
    ...
    public void testPonerVacuna(){
        ...
        boolean subidaDeNivel=Nivel.incrementarExperiencia(false,true);
